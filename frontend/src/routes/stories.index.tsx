...
export const Route = createFileRoute("/stories/")({
  head: () => ({
    meta: [
      { title: "Stories — Life, In Receipts" },
      { name: "description", content: "Discovered chapters supported by connected digital moments." },
      { property: "og:title", content: "Discovered Stories — Life, In Receipts" },
      { property: "og:description", content: "Explore recurring routines and chapters found across the archive." },
