...
export const Route = createFileRoute("/receipts")({
  head: () => ({
    meta: [
      { title: "Receipts — Life, In Receipts" },
      { name: "description", content: "Search and explore every collectible moment across three datasets." },
      { property: "og:title", content: "Receipt Archive — Life, In Receipts" },
      { property: "og:description", content: "Browse the raw fragments behind every discovered story." },
