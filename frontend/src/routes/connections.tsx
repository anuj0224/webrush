...
export const Route = createFileRoute("/connections")({
  head: () => ({
    meta: [
      { title: "Connections — Life, In Receipts" },
      { name: "description", content: "Explore why moments from different parts of the archive belong together." },
      { property: "og:title", content: "Connections — Life, In Receipts" },
      { property: "og:description", content: "A constellation of related places, songs, purchases, and events." },
