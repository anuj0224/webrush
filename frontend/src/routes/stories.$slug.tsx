...
export const Route = createFileRoute("/stories/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: `${loaderData?.title ?? "Story"} — Life, In Receipts` },
      { name: "description", content: loaderData?.summary ?? "A connected story from the archive." },
      { property: "og:title", content: `${loaderData?.title ?? "Story"} — Life, In Receipts` },
      { property: "og:description", content: loaderData?.summary ?? "A connected story from the archive." },
